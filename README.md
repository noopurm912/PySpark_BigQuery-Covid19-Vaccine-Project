...
•	Then created a pyspark jupyter notebook in the cluster and read the dataset from cloud storage. Dataproc enables the use of cloud storage in parallel with HDFS. <br
